...
import com.tecmanic.servicepartner.Constants.CustomVolleyJsonArrayRequest;
...
import static com.tecmanic.servicepartner.Constants.Config.BuyBooking;
import static com.tecmanic.servicepartner.Constants.Config.serviceDetails;
    ...
    private void servvIceDetailsURl(final String bookingID) {
       ...
       /* CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Log.d("serviceDetails", response.toString());
                progressDialog.dismiss();*/
           /*     try {
