...
public class Config {
    ...
    static final String APP_NAME = "GoServices";
    public static final String PREFS_NAME = "GoServicesLoginPrefs";
    public static final String PREFS_NAME2 = "GoServicesLoginPrefs2";
