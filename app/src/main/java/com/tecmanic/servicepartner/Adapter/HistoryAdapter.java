package com.tecmanic.servicepartner.Adapter;
...
import com.tecmanic.servicepartner.ModelClass.HistoryModelClass;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.MyViewHolder> {
    ...
    Context context;
    public HistoryAdapter(Context context, List<HistoryModelClass> list) {
    ...
    public HistoryAdapter(List<HistoryModelClass> moviesList) {
