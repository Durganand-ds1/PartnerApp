...
import com.tecmanic.servicepartner.ModelClass.withdrawModelClass;
...
public class WithdrawalAdapter extends RecyclerView.Adapter<WithdrawalAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if(movie.getComplete().equalsIgnoreCase("0")){
            ...
            holder.address.setTextColor(context.getResources().getColor(R.color.green));
            holder.send.setVisibility(View.GONE);
        }
...
//        });
        alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
              ...
              /*  ProfileFragment tm = new ProfileFragment();
